...
```bash
tensorboard --logdir train --port 2223 &

python ppoagent_test.py --root_dir=~/Documents/GitHub/gym-solventx/test_agents --logtostderr
...
flags.DEFINE_string('env_name', 'gym_solventx-v0', 'Name of an environment')
flags.DEFINE_integer('replay_buffer_capacity', 1001,
                     'Replay buffer capacity per env.')
flags.DEFINE_integer('num_parallel_environments', 15,
...
flags.DEFINE_integer(
    'collect_episodes_per_iteration', 15,
...
def train_eval(
  ...
  train_dir = os.path.join(root_dir, 'run2/train')
  eval_dir = os.path.join(root_dir, 'run2/eval')
  saved_model_dir = os.path.join(root_dir, 'run2/policy_saved_model')
