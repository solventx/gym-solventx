...
```bash
tensorboard --logdir $HOME/tmp/ppo/gym/gym_solventx-v0/ --port 2223 &

python train_eval_clip_agent.py --root_dir=$HOME/tmp/ppo/gym/gym_solventx-v0/ --alsologtostderr
```
"""
  ...
  with tf.compat.v2.summary.record_if(
    ...
    tf_env = tf_py_environment.TFPyEnvironment(
        parallel_py_environment.ParallelPyEnvironment(
            [lambda: py_env] * num_parallel_environments))
